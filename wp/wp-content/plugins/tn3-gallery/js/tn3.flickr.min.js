...
function(e,h){g={raw:h};f.extend(g,{title:h.title,description:h.description._content,thumb:c.getFlickrURL(h,c.config.thumbSize),img:c.getFlickrURL(h,c.config.imageSize)});if(h.media=="video")g.content=c.getVideoContent(h,b.photos.owner,g.img);a.push(g)});this.extcon.setImageData(a,d)},getFlickrURL:function(b,d,a){if(a==undefined)a="";return"http://farm"+b[a+"farm"]+".static.flickr.com/"+b[a+"server"]+"/"+b[a+"id"]+"_"+b[a+"secret"]+"_"+d+".jpg"},getVideoContent:function(b,d,a){return'<video poster="'+
a+'" type="video/mp4" src="'+("http://www.flickr.com/photos/"+d+"/"+b.id+"/play/site/"+b.secret+"/")+'" controls="controls" preload="none"></video>'},parseGalleries:function(b){var d=[],a=this,c;f.each(b.galleries.gallery,function(g,e){c={raw:e};f.extend(c,{title:e.title._content,description:e.description._content,thumb:a.getFlickrURL(e,a.config.thumbSize,"primary_photo_"),adata:{id:e.id,origin:"flickr"}});d.push(c)});this.extcon.setAlbumData(d)},parseGalleryInfo:function(b){var d=[],a=b.gallery;
b={raw:a};f.extend(b,{title:a.title._content,description:a.description._content,thumb:this.getFlickrURL(a,this.config.thumbSize,"primary_photo_"),adata:{id:a.id,origin:"flickr"}});d.push(b);this.extcon.setAlbumData(d)},parsePhotosets:function(b){var d=[],a=this,c;f.each(b.photosets.photoset,function(g,e){c={raw:e};f.extend(c,{title:e.title._content,description:e.description._content,thumb:a.getFlickrURL(f.extend({},e,{id:e.primary}),a.config.thumbSize),adata:{farm:e.farm,id:e.id,origin:"flickr"}});
d.push(c)});this.extcon.setAlbumData(d)},parseSetInfo:function(b){var d=[],a=b.photoset;b={raw:a};f.extend(b,{title:a.title._content,description:a.description._content,thumb:this.getFlickrURL(f.extend({},a,{id:a.primary}),this.config.thumbSize),adata:{farm:a.farm,id:a.id,origin:"flickr"}});d.push(b);this.extcon.setAlbumData(d)},parsePhotoset:function(b,d,a){var c=[],g=this,e;f.each(b.photoset.photo,function(h,i){i.farm=d.farm;e={raw:i};f.extend(e,{title:i.title,description:i.description._content,
thumb:g.getFlickrURL(i,g.config.thumbSize),img:g.getFlickrURL(i,g.config.imageSize)});if(i.media=="video")e.content=g.getVideoContent(i,b.photoset.owner,e.img);c.push(e)});this.extcon.setImageData(c,a)}}})(jQuery);
